...
var canvas = document.getElementById('stage');
 ...
 ctx.lineWidth = 3;
	...
	var posX = 0;
	var boxWidth = 10;  //variable donde inicia el relleno azul
...
//ctx.globalAlpha=1;
	...
	for(var i=0;i<10;i++){
		 ctx.lineWidth = 3;
				...
				ctx.fillStyle="black";
				ctx.font="bold 20px verdana";
				ctx.fillText(""+i-5,10+(i*60)-12, 55); //pone numeros en la recta numerica
}		
ctx.fillStyle="CornflowerBlue";
ctx.globalAlpha=0.6;
			ctx.fillRect(0,0,posX+10,130); ///rellena la recta numerica si gana
